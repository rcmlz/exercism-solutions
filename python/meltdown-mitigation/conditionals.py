...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    return temperature < MAX_TEMP and neutrons_emitted > MIN_NEUTRONS and temperature * neutrons_emitted < 500000.0
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    signal = temperature * neutrons_produced_per_second
    code = "DANGER"
    if signal < 0.9 * threshold:
        code = "LOW"
    elif 0.9 * threshold <= signal <= 1.1 * threshold:
        code = "NORMAL"
    return code
